...
module.exports = function(app){
    ...
    app.route('/users/customer/forgot-password').put(resetPasswordController.update);
    app.route('/users/customer/forgot-password/check').get(resetPasswordController.find);
    ...
    app.route('/order/find').get(auth.isAunthenticated,orderController.find);
    ...
    app.route('/store-visit/count').get(auth.isAunthenticated,visitorController.count);
    app.route('/store-visit').post(auth.isAunthenticated,visitorController.create);
