...
exports.countOrder = function (req,res){
    try{
        ...
        .then(function(decryptedData){
            ...
            order.countOrderInStore(security,param,function(message, status,data){
                if(status == 200 || status == 201){
                    if(data == null || data == ""){
                        response.ok('empty result', status, data, res); 
                    }else{
...
exports.countOmzet = function (req,res){
    try{
        log.order.info("Controller - request from : "+req.connection.remoteAddress);
        let userToken = req.user;
        let param = req.query;
        ...
        .then(function(decryptedData){
            param.idStore = decryptedData[0];
            order.countOmzet(security,param,function(message, status,data){
                if(status == 200 || status == 201){
                    if(data == null || data == ""){
                        response.ok('empty result', status, data, res); 
                    }else{
...
exports.countBestCategory = function (req,res){
    try{
        log.order.info("Controller - request from : "+req.connection.remoteAddress);
        let userToken = req.user;
        let param = req.query;
...
//        }
        ...
        .then(function(decryptedData){
            param.idStore = decryptedData[0];
            order.countCategoryBestSeller(security,param,function(message, status,data){
                if(status == 200 || status == 201){
                    if(data == null || data == ""){
                        response.ok('empty result', status, data, res); 
                    }else{
...
exports.countBestSeller= function (req,res){
    try{
        log.order.info("Controller - request from : "+req.connection.remoteAddress);
        let userToken = req.user;
        let param = req.query;
...
//        }
        ...
        .then(function(decryptedData){
            param.idStore = decryptedData[0];
            order.countProductBestSeller(security,param,function(message, status,data){
                if(status == 200 || status == 201){
                    if(data == null || data == ""){
                        response.ok('empty result', status, data, res); 
                    }else{
